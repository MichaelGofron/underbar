(function() {
  ...
  _.uniq = function(array) {
    // go through all elements in array pushing to a new array
    // if any elemeent in the old array is contained in the new array don't add
    // otherwise add

    var previousValues = [];
    // filter array based on duplicates?
    for (var el = 0; el < array.length; el++){
      if (_.indexOf(previousValues,array[el]) == -1){
        previousValues.push(array[el]);
      }
    }
